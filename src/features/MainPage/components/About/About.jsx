...
import SeasonWaterfall from './SeasonWaterfall';

const GITHUB_URL = "https://github.com/jjop2";
const EMAIL = "jngsuh616@gmail.com";

const About = ({ currentSeason }) => {
  return (
    <div className="about w-max">
      <div className="about_cont_wrap section-h">
        ...
        <div className="about_description">
          ...
          <p className="desc_block">가을의 결실을 맺어 편리함을 선물하는 과정을 좋아합니다.</p>
      ...
      <div className="about_photo_wrap">
        <div className="season_section">
          <p>now_season = "{currentSeason}"</p>
        </div>
        <div className="photo_section">
          <SeasonWaterfall currentSeason={currentSeason} />
        </div>
      </div>
    </div>
  );
